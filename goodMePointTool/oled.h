...
/* 端口引脚宏定义,方便程序移植 */
#define  GPIO_OLED_CLK  				RCC_APB2Periph_GPIOB
#define  GPIO_OLED_SCLK_Pin     GPIO_Pin_3							/* D0 */
#define  GPIO_OLED_PIN_Pin     	GPIO_Pin_4							/* D1 */
#define  GPIO_OLED_RES_Pin     	GPIO_Pin_5							/* RES */
#define  GPIO_OLED_DC_Pin     	GPIO_Pin_6							/* DC */
...
#define OLED_RST_Clr() GPIO_ResetBits(GPIOB,GPIO_Pin_5)	//RES RES => 接RES引脚
#define OLED_RST_Set() GPIO_SetBits(GPIOB,GPIO_Pin_5)

#define OLED_DC_Clr() GPIO_ResetBits(GPIOB,GPIO_Pin_6)	//DC  DC  => 接DC引脚
#define OLED_DC_Set() GPIO_SetBits(GPIOB,GPIO_Pin_6)

/* 使用4线串行接口时使用 */ 
#define OLED_SCLK_Clr() GPIO_ResetBits(GPIOB,GPIO_Pin_3)//CLK D0  => 接D0引脚
#define OLED_SCLK_Set() GPIO_SetBits(GPIOB,GPIO_Pin_3)

#define OLED_SDIN_Clr() GPIO_ResetBits(GPIOB,GPIO_Pin_4)//PIN D1  => 接D1引脚
